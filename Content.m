% This MATLAB/Octave code implements the FFDIAG algorithm for joint 
% approximate diagonalization of several matrices.
% The algorithm is based on the Frobenius-norm formulation of the 
% joint diagonalization problem, and addresses diagonalization 
% with a general, non-orthogonal transformation. 
% The iterative scheme of the algorithm is based on a
...
%
% To get started type "help ffdiag" in the MATLAB/Octave command window
% or run the simple_check.m for a short demo
% 
% Octave is freely available at  http://www.octave.org 